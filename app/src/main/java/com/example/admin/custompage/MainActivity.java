package com.example.admin.custompage;
...
import com.example.admin.custompage.Model.User;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String customHtml = "<div align=\"center\">\n" +
                ...
                "  <textarea name=\"myTextBox\" cols=\"20\" rows=\"4\" style=\"border:3px dashed #F7730E;\" id=\"txtfname\">\n" +
                "\t</textarea><br><br>\n" +
                "   \t<script>\n" +
                "    function getValues() {\n" +
